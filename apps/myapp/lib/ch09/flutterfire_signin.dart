            ...
            builder: (BuildContext context) {
              return TextButton(
                onPressed: () async {
                  ...
                  ScaffoldSnackbar.of(context).show('$uid has successfully signed out.');
                },
                  ...
                  children: [
                    ...
                    IconButton(
                      onPressed: () => showDialog(
                        context: context,
                        builder: (context) => UpdateUserDialog(user: widget.user),
                      ),
...
class _EmailPasswordFormState extends State<_EmailPasswordForm> {
  ...
  Future<void> _signInWithEmailAndPassword() async {
    try {
      ...
      ScaffoldSnackbar.of(context).show('Failed to sign in with Email & Password');
    }
  }
}
...
class _AnonymouslySignInSectionState extends State<_AnonymouslySignInSection> {
  ...
  Future<void> _signInAnonymously() async {
    try {
      ...
      ScaffoldSnackbar.of(context).show('Signed in Anonymously as user ${user.uid}');
    } catch (e) {
...
class _PhoneSignInSectionState extends State<_PhoneSignInSection> {
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'PhoneNumber (+x xxx-xx-xxxx)',
                  ),
                  validator: (String? value) {
                    if (value!.isEmpty) {
                      return 'Phone number (+x xxx-xx-xxxx)';
                    }
                    return null;
                  },
                ),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextFormField(
              controller: _phoneNumberController,
              decoration: const InputDecoration(
                labelText: 'Phone number (+x xxx-xx-xxxx)',
              ),
              validator: (String? value) {
                if (value!.isEmpty) {
                  return 'Phone number (+x xxx-xx-xxxx)';
  ...
  Future<void> _confirmCodeWeb() async {
    if (webConfirmationResult != null) {
      ...
      ScaffoldSnackbar.of(context).show('Please input sms code received after verifying phone number');
    }
  }
  ...
  Future<void> _verifyPhoneNumber() async {
    ...
    PhoneVerificationCompleted verificationCompleted = (PhoneAuthCredential phoneAuthCredential) async {
      ...
      ScaffoldSnackbar.of(context).show('Phone number automatically verified and user signed in: $phoneAuthCredential');
    };
  ...
  Future<void> _signInWithPhoneNumber() async {
    try {
      ...
      ScaffoldSnackbar.of(context).show('Successfully signed in UID: ${user.uid}');
    } catch (e) {
      print(e);
...
class _OtherProvidersSignInSection extends StatefulWidget {
  ...
  @override
  _OtherProvidersSignInSectionState createState() => _OtherProvidersSignInSectionState();
}
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              alignment: Alignment.center,
              child: kIsWeb
                  ? const Text('When using Flutter Web, API keys are configured through the Firebase Console.'
                      'The below providers demonstrate how this works')
